CREATE DATABASE  IF NOT EXISTS `db_clc1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_clc1`;
-- MySQL dump 10.13  Distrib 8.0.21, for Win64 (x86_64)
--
-- Host: localhost    Database: db_clc1
-- ------------------------------------------------------
...
CREATE TABLE `aplicacion` (
  ...
  `nombre_aplicacion` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion_aplicacion` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `ascenso` (
  ...
  `fecha_ascenso` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `baja` (
  ...
  `fecha_despido_baja` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `causa_bajas` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `balance_encabezado` (
  `pk_id_balance_encabezado` int NOT NULL,
  `descripcion_balance_encabezado` varchar(75) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `banco` (
  ...
  `nombre_banco` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `bitacora` (
  ...
  `fechahora_bitacora` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `direccionhost_bitacora` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombrehost_bitacora` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `accion_bitacora` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `bodega` (
  ...
  `descripcion_bodega` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `dimensiones_bodega` double(5,2) NOT NULL,
  `direccion_bodega` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `capacitacion` (
  ...
  `resultado_capacitacion` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `categoria_producto` (
  ...
  `nombre_categoria_producto` varchar(35) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion_categoria_producto` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `categoria_producto` VALUES (1,'Prueba Categoria Producto','Descipcion categoria producto 1',1),(2,'Prueba 2 categoria','Cat 2 Prueba',1),(3,'pruebahoy','prueba',1),(4,'pureba4','prueba4',0),(5,'Limpieza','articulos de limpieza',0),(6,'Limpieza','Articulos de limpieza y hogar',1),(7,'Corte','Fase de Corte',1),(8,'Hogar','Articulos de hogar',1),(9,'Electronicos','Articulos electronicos',1),(10,'Salud','Articulos de cuidados Personales',1);
...
CREATE TABLE `clientes` (
  ...
  `nit_cliente` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha` datetime DEFAULT NULL,
  `nombre_cliente` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido_cliente` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `telefono` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `correo_cliente` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `direccion_cliente` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `consulta_inteligente` (
  ...
  `nombre_consulta_inteligente` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `contenido_consulta_inteligente` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `control_calidad` (
  ...
  `resultado_control_calidad` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `control_empleado` (
  ...
  `horas_extras_de_trabajo` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `comisiones_ventas` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `control_producto` (
  ...
  `resultado_control_producto` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `correo_proveedor` (
  ...
  `fk_id_proveedor` int NOT NULL,
  `correo_correo_proveedor` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `cotizacion` (
  ...
  `total_cotizacion` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado_cotizacion` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `cuenta_contable` (
  `pk_id_cuenta_contable` int NOT NULL,
  `nombre_cuenta_contable` varchar(75) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `curso` (
  ...
  `nombre_curso` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fk_id_empleado_curso` int DEFAULT NULL,
  `detalle_curso` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `deduccion` (
  ...
  `nombre_deduccion` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `monto_deduccion` double DEFAULT NULL,
  `descripcion_deduccion` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `departamento` (
  ...
  `nombre_departamento` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion_departamento` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `departamento_empresarial` (
  ...
  `nombre_departamento_empresarial` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `detalle_bitacora` (
  ...
  `querryantigua_detalle_bitacora` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `querrynueva_detalle_bitacora` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `detalle_factura` (
  ...
  `fk_id_producto` int NOT NULL,
  `DETALLE_FACTURAcol` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `detalle_hora_empleado` (
  ...
  `descripcion_detalle_hora_empleado` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `direccion` (
  ...
  `departamento_direccion` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `zona_direccion` varchar(7) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `municipio_direccion` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `residencia_direccion` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `empleado` (
  ...
  `nombre1_empleado` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombre2_empleado` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido1_empleado` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido2_empleado` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha_nacimiento_empleado` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dpi_empleado` int DEFAULT NULL,
  `fk_id_genero_empleado` int DEFAULT NULL,
  `fk_id_estado_civil_empleado` int DEFAULT NULL,
  `email_empleado` varchar(125) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `encabezado_capacitacion` (
  ...
  `fecha_inicio_encabezado_capacitacion` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha_fin_encabezado_capacitacion` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `encabezado_competencia` (
  ...
  `fecha_inicio_encabezado_competencia` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha_fin_encabezado_competencia` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `encabezado_nomina` (
  ...
  `nombre_encabezado_nomina` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha_inicio_encabezado_nomina` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha_fin_encabezado_nomina` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `entrevista` (
  ...
  `comentarios_entrevistador_entrevista` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `estado_civil` (
  ...
  `nombre_estado_civil` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `estado_produccion` (
  ...
  `nombre_estado_produccion` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `duracion_estado_produccion` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `fabrica` (
  ...
  `direccion_fabrica` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `telefono_fabrica` int NOT NULL,
  `descripcion_fabrica` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `facturas` (
  ...
  `total_factura` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `falta` (
  ...
  `nombre_falta` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descripción_falta` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `falta_empleado` (
  ...
  `fecha_falta_empleado` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `formacion_academica` (
  ...
  `nombre_formacion_academica` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `genero` (
  ...
  `nombre_genero` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `horario` (
  ...
  `nombre_horario` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descripcion_horario` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `licencia_conduccion` (
  ...
  `tipo_licencia_conduccion` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `linea_producto` (
  ...
  `nombre_linea_producto` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion_linea_producto` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `login` (
  ...
  `usuario_login` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `contraseña_login` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombreCompleto_login` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `login` VALUES (1,'sistema','LKAekHU9EtweB49HAaTRfg==','Usuario de prueba',1),(2,'bjsican','0FOYy5u5h0djKjzCYqfvkg==','Billy Sican',1),(3,'bmaza','ksw6dqRXYQ9hvdxeiHlyyQ==','Bryan Mazariegos',1),(4,'jsican','jsican','Jeshua Sican',0),(5,'jmorataya','123','Julio Morataya',0);
...
CREATE TABLE `marca` (
  ...
  `descripcion_marca` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `modulo` (
  ...
  `descripcion_modulo` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `movimiento_inventario` (
  ...
  `descripcion_movimiento_inventario` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `municipio` (
  ...
  `nombre_municipio` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion_municipio` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `orden_compra` (
  ...
  `fecha_envio_orden_compra` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `orden_compra` VALUES (1,2,'10-11-2020 22:42:39',100,1),(2,1,'09-11-2020 22:58:19',1500,1),(3,3,'10-11-2020 23:12:55',1250,1),(4,4,'20-11-2020 13:39:54',1250,1),(5,1,'25-11-2020 14:06:49',5000,1);
...
CREATE TABLE `pais` (
  ...
  `nombre_pais` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
  `capital_pais` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `pedido_encabezado` (
  ...
  `fec_pedido_pedido_encabezado` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `percepcion` (
  ...
  `nombre_percepcion` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `monto_percepcion` double DEFAULT NULL,
  `descripcion_percepcion` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `perfil` (
  ...
  `descripcion_perfil` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `peticion_poliza` (
  ...
  `concepto_peticion_poliza` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha_peticion_poliza` datetime DEFAULT NULL,
  `descripcion_peticion_poliza` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `poliza_encabezado` (
  ...
  `descripcion_poliza_encabezado` varchar(75) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `producto` (
  ...
  `descripcion_producto` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `propietario` (
  ...
  `nombre_propietario` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descripcion_propietario` varchar(75) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `proveedor` (
  ...
  `razon_social_proveedor` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `representante_legal_proveedor` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `nit_proveedor` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `puesto` (
  ...
  `nombre_puesto` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `recetas_encabezado` (
  ...
  `descripcion_receta_encabezado` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `reclutamiento` (
  ...
  `nombre1_reclutamiento` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombre2_reclutamiento` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido1_reclutamiento` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido2_reclutamiento` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha_nacimiento_reclutamiento` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `email_reclutamiento` varchar(125) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `nombre_profesion` varchar(125) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `reporte` (
  ...
  `nombre_reporte` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
  `ruta_reporte` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `ruta` (
  ...
  `origen_ruta` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
  `destino_ruta` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion_ruta` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `telefono_proveedor` (
  ...
  `fk_id_proveedor` int NOT NULL,
  `telefono_telefono_proveedor` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tipo_baja` (
  ...
  `nombre_tipo_baja` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tipo_competencia` (
  ...
  `nombre_competencia` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tipo_cuenta_contable` (
  ...
  `nombre_tipo_cuenta_contable` varchar(75) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tipo_cuenta_por_cobrar` (
  ...
  `nombre_cuenta` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tipo_entrevista` (
  ...
  `nombre_tipo_entrevista` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tipo_moneda` (
  ...
  `moneda_tipo_moneda` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `simbolo_tipo_moneda` varchar(2) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descripcion_tipo_moneda` varchar(75) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tipo_movimiento` (
  ...
  `nombre_tipo_movimiento` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `signo_tipo_movimiento` varchar(1) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tipo_transaccion` (
  ...
  `nombre_tipo_transaccion` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descripcion_tipo_transaccion` varchar(75) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `transaccion` (
  ...
  `descripcion_transaccion` varchar(75) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `vehiculo` (
  ...
  `placa_vehiculo` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `modelo_vehiculo` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `color_vehiculo` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `anio_vehiculo` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `tipo_combustible_vehiculo` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping events for database 'db_clc1'
--

--
-- Dumping routines for database 'db_clc1'
--
...
-- Dump completed on 2020-11-24 14:18:51
